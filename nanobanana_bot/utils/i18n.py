...
STRINGS: Dict[str, Dict[str, str]] = {
    "ru": {
        ...
        # Generate
        "gen.choose_method": "🪄 <b>Seedream: выберите режим</b>",
        "gen.type.text": "Seedream • Текст → Изображение ✨",
        "gen.type.text_photo": "Seedream • Текст + Фото ✨",
        "gen.type.text_multi": "Seedream • Текст + Несколько фото ✨",
        "gen.type.edit_photo": "Seedream • Редактировать фото ✂️",
        "gen.enter_prompt": "📝 Seedream: опишите идею для изображения",
        ...
        "gen.upload_photo": "📷 Seedream: добавьте фото, которое учитывается при генерации.",
        "gen.edit.enter_prompt": "✍️ Seedream: что изменить в фото?",
        "gen.choose_count": "📷 <b>Seedream: выберите количество фото</b>\n\n• 1–5 в первом ряду, 6–10 во втором\n• Нажмите ‘Запустить ✅’",
        ...
        "gen.summary.title": "🔍 <b>Seedream: проверьте детали</b>",
        ...
        "gen.confirm.ok": "✅ Запустить Seedream",
        "gen.confirm.cancel": "❌ Отмена",
        "gen.canceled": "Seedream: генерация отменена.",
        "gen.not_enough_tokens": "Seedream требует 4 токена. Ваш баланс: {balance}.\nПополнить: /topup",
        "gen.done_text": "✨ Seedream готово! Остаток: {balance}\nСоотношение: {ratio}",
        "gen.result_caption": "Seedream результат ✨",
        "gen.task_accepted": "Задача отправлена в Seedream. Результат скоро будет здесь ✨",
    ...
    "en": {
        ...
        # Generate
        "gen.choose_method": "🪄 <b>Seedream: choose a mode</b>",
        "gen.type.text": "Seedream • Text → Image ✨",
        "gen.type.text_photo": "Seedream • Text + Photo ✨",
        "gen.type.text_multi": "Seedream • Text + Multiple Photos ✨",
        "gen.type.edit_photo": "Seedream • Edit Photo ✂️",
        "gen.enter_prompt": "📝 Seedream: describe your idea",
        # Short placeholders for input fields
        "ph.prompt": "Describe your idea…",
        "ph.edit_prompt": "What to change?",
        "gen.prompt_empty": "Please send a text prompt.",
        "gen.upload_photo": "📷 Seedream: attach a photo to guide generation.",
        "gen.edit.enter_prompt": "✍️ Seedream: what should be changed or added?",
        "gen.choose_count": "📷 <b>Seedream: choose number of photos</b>\n\n• 1–5 in the first row, 6–10 in the second\n• Press ‘Launch ✅’",
        ...
        "gen.choose_ratio": (
            "📐 <b>Seedream: choose orientation & aspect</b>\n\n"
            "◻️ Square: 1:1\n"
            "📱 Portrait: 3:4, 2:3, 9:16\n"
            "🖼️ Landscape: 4:3, 3:2, 16:9, 21:9"
        ),
        "gen.ratio.auto": "Auto (same as source photo)",
        "gen.summary.title": "🔍 <b>Seedream: review details before generation</b>",
        ...
        "gen.confirm.ok": "✅ Launch Seedream",
        "gen.confirm.cancel": "❌ Cancel",
        "gen.canceled": "Seedream generation cancelled.",
        "gen.not_enough_tokens": "Seedream needs 4 tokens. Your balance: {balance}.\nTop up: /topup",
